...
public class CommandeController implements Serializable {
    ...
    @EJB
    private ejb.CommandeFacade ejbFacade;
    @EJB
    ...
    private void putOrderInSession(Commande order) {
    ...
    public String payer(){
        ...
        current.setTotalprice(totalPrice(cart));
        current.setTime(time);
        commandeEJB.create(current);
        return "facture";
    }
    ...
    public String create() {
        try {
            ...
            current.setId(52);
            current.setUserid(1);
            current.setTotalprice(200);
            current.setTime(2010213210);
